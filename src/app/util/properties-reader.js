...
import propertyAppender from './properties-appender';
import propertyWriter  from './properties-writer';

const has = Object.prototype.hasOwnProperty.call.bind(Object.prototype.hasOwnProperty);

const SECTION = Symbol('SECTION');

export default function PropertiesReader (sourceFile, encoding, options = {}) {
